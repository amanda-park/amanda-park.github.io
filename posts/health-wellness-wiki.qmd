...
* There is a difference between worry and anxiety, though they are often conflated:
  * *Worry* is time-limited and often tied to a specific issue. Once the issue resolves the worry typically disappears
  * *Anxiety* tends to be more broad, persists over time, and often disrupts daily activities/the future through behaviors like procrastination and avoidance
...
* Radical acceptance (or in current self-help lingo, the "let them" theory) works great with day to day situations that people can't really control; however, if this approach is used nonstop, it will lead you to become an overly complacent doormat. Use more in these types of scenarios:
  * Someone flaking on you after a first date? Let them (and move on)
  * Family not taking your advice on an issue? Let them (and free yourself mentally)
  * Friends hanging out without you? Let them (and don't beat yourself up over it if it's not repeated behavior)
...
* Remember the spotlight effect - You're not special; people are too self-absorbed to be thinking of you. Besides, it's not your business what other people think of you
* Excessive self-monitoring can give the wrong impression to others; remember how you feel inside is not how you look to others
* Don't tell yourself you have to perform perfectly, as that creates impossible standards
...
Boredom is wanting to do something fulfilling, yet nothing fitting the bill. Different from apathy (the absence of any desire). Boredom is a sign that you're having a 'crisis of agency' and are passively letting life happen to you, rather than deploying your skills/talents in a meaningful way.

Signs of boredom:

* Feeling understimulated
* Tasks (if any) seem meaningless and unsatisfying
* Time seems to stretch out

Managing boredom:

* *Re-establish your agency* - Boredom signals a need to look for activities that flow from and give expression to your curiosity, creativity, and passion. This means you don't follow a list online giving you hobbies/activities to alleviate your boredom. 
* *Don't numb boredom with drugs/technology/etc; actually relax* - boredom is unpleasant, but resistance and numbing won't help working through it (acceptance is needed). Further, actual relaxation is needed, typically in times people prefer to numb themselves, to avoid feeling restless and agitated.
* *Just do things* - frequent boredom can lead to "analysis paralysis", and the preoccupation with doing things "right" means never getting started.
* *Reframe situations* - use gamification or other methods of making something more fun to make repetitive tasks a little less boring.
...
There is also a difference between healthy sadness (a natural response to losing something) and depression (having distorted thoughts on top of losing something, making the situation worse)
...
*People would rather be consistent than happy.*

Happiness can be defined in a lot of different ways, but is often driven by connection. There are three key feelings involved, including:

* *Enjoyment* - pleasure + elevation
  * Make time to have fun on your calendar; don't see it as frivolous or optional.
  * If unsure what you find fun, look at your envy (it's instructive and tells you what you desire) and not the "shoulds" you carry (ie, "what do I want" vs "what should I do")
* *Satisfaction*
* *Purpose*

Some ways the below can play out include:
...
* Learn to tolerate boredom through either meditation or other means
...
Shame is the feeling that you’re an inherently bad or flawed person. and thus unworthy of love/belonging and/or incapable of change. Often develops in childhood and persists throughout adulthood. When we feel shame, we might believe that we’re unworthy of love or incapable of change. Effectively, shame is the gap between who we are (current self) and what we want and/or believe we should be (ideal self), and needs secrecy and judgment to thrive.
...
* Be aware of scarcity culture, which says we're never "enough" and encourages numbing behaviors, by living wholeheartedly
  * Love
  * Belonging
  * Vulnerability
* Self-worth has no prerequisites, and when bad things happen, they don't dictate your self-worth
* Be aware of shame and name it when it occurs for you
* Practice empathy with perspective-taking and nonjudgmental understanding
...
Defense mechanism to cope with emotional neglect and also is about safety. Reasons why people do it include:

* Facilitates self-improvement
* Keep ego in check
* Avoid other people's criticism by being first to the punch
* Reduce expectations of others
* Gain a sense of control in an arbitrary world
* Gain reassurance and compliments from others

3 main factors in perfectionistic self-criticism include:

* Harshness - relying on shame and/or beating ourselves up to do better
* All or nothing approach - one mistake ruins everything
* Personal implication - believing something is wrong with you or that you were inadequate
...
* Describe yourself in terms not associated with success in career, appearance, or how others think of you
...
* Conditional self-worth; only being worthy if your relationships, appearance, net worth, career, or achievements are X.
  * Success-based self-worth - ex, how much do I make, did I act normal at this social event, etc.
  * Activity-based self-worth - how much work did I get done today, how close am I to achieving my goals, etc.
...
* Live authentically by letting go of other people's expectations
  * Be willing to say "no" when you don't want to/can't do something; have a mantra to assist if saying no is tough
  * Be willing to say "yes" when you are genuinely interested in something
...
* Resilience (resourceful, problem-solving skills, willing to ask for help, proactive, build support system for selves and invest into being connected with others, and are hopeful and aware of emotions) will lead to letting go of numbing and powerlessness
  * Live a life that matches your naturally built needs
  * Practice spirituality
  * Healthy venting
* Avoid foreboding joy by practicing gratitude
* Intuition and Trust will lead to letting go of certainty (which isn't even real)
  * Overcome fear of comparison
  * Experiment with artistic ventures
* Creativity (expressing self in unique way) will lead to letting go of comparison
* Play and Rest (playing to enjoy life, not for any purpose; doing things that make one feel alive like rest, play, fulfilling connections, and creativity) will lead to letting go of exhaustion
...
**Vestibular** - Processes balance and movement
...
**Proprioception** - Processes balance and coordination
...
**Interoception** - Processes internal body and emotional states
...
* Self-enquiry
  ...
  * Find the visceral "edge" that makes you react disproportionately to an experience, and ask "What is it that I might need to learn from the experience?"
...
Ask a doctor before following a fitness regimen, etc
...
| Shrugs                     | Trapezius              |                                                 |
| Dips                       | Triceps, Chest         |                                                 |
| Farmer's Walk              | Forearms, Grip, Core   |                                                 |
...
| Plank               | Core                   | Maintain a straight line from head to heels     |
| Side Plank          | Obliques, Core         | Keep hips elevated and body straight            |
| Russian Twist       | Obliques, Core         | Rotate torso for maximum engagement              |
| Dips                | Triceps, Chest, Core   |                                                 |
| Bird Dog            | Core, Back             | Focus on balance and stability                   |
| Mountain Climbers   | Core, Legs             | Keep a steady pace for cardio and core strength  |
| Pike Press (and Shrug) | Shoulders, Core      | Engage core while pressing up                    |
...
| Calf Raises                  | Calves         |                                                 |
| Clam Shells                  | Gluteus Medius         |                                                 |
| Glute Bridges                | Gluteus Maximus, Hamstrings, Transversus Abdominis         | Flare legs out for more burn in hamstrings/glutes |
| Single Leg Romanian Deadlifts | Hamstrings, Glutes |                                             |
| Reverse Lunge | Hamstrings, Glutes |                                             |
| Reverse Plank | Lower Back, Hamstrings, Glutes, Abdominals |  
| Side Lying Hip Adduction | Gluteus Medius, Outer Thigh |  |
